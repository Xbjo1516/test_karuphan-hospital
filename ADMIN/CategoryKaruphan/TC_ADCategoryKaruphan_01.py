...
try:
    ...
    driver.find_element(By.XPATH,"//input[@placeholder='ชื่อหมวดหมู่ครุภัณฑ์']").send_keys("ครุภัณฑ์การแพทย์และวิทยาศาสตร์")
    ...
    driver.save_screenshot(os.path.join(folder_name, "TC_ADCategoryKaruphan_01.png"))
    time.sleep(1)
