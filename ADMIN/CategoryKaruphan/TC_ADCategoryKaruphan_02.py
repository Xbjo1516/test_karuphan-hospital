...
try:
    ...
    Editname = WebDriverWait(driver, 10).until(
        EC.presence_of_element_located((By.XPATH, "//table/tbody/tr/td[2]/input"))).send_keys("000")
    driver.find_element(By.XPATH,"//section[1]//table/tbody/tr/td[3]/input").send_keys("วิทยาศาสตร์")
    time.sleep(1)
    driver.find_element(By.XPATH,"//section[1]/div[2]/table/tbody/tr/td[4]/button[1]").click()
    time.sleep(5)
    
    driver.save_screenshot(os.path.join(folder_name, "TC_ADCategoryKaruphan_02.png"))
    time.sleep(1)
