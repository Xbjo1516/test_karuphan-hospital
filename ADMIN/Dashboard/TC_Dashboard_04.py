...
try:
    ...
    total = WebDriverWait(driver, 10).until(
        EC.presence_of_element_located((By.XPATH, "//section/div[2]/div[1]/div/div/p[2]"))).text
    time.sleep(1)
    ...
    text = driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div[2]/div/div[1]/div/button[1]").get_attribute("textContent")
