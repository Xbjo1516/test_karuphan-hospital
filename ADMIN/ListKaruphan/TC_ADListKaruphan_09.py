...
try:
    ...
    driver.find_element(By.XPATH,"//input[@placeholder='0000-000-0000/0']").send_keys("1111-222-3333/99")
    ...
    driver.find_element(By.XPATH,"//input[@placeholder='60,000']").send_keys("3000")
    ...
    driver.save_screenshot(os.path.join(folder_name, "TC_ADListKaruphan_09.png"))
    time.sleep(1)
