...
try:
    ...
    driver.find_element(By.XPATH, "//section/div[2]/table/tbody/tr[1]/td[7]/button").click()
    time.sleep(2)
    ...
    driver.save_screenshot(os.path.join(folder_name, "TC_EXBorrowKaruphan_01.png"))
    time.sleep(1)
