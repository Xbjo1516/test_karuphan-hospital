...
try:
    ...
    #print(f"a = '{amount}'")
    assert amount == "รวม 1 ชิ้น จาก 1 รายการ"
    print("✅ Check the success words")
    time.sleep(2)
    ...
    driver.find_element(By.XPATH, "//form/div[2]/div/input").send_keys("10/1/2025")
    driver.find_element(By.XPATH, "//form/div[3]/div/textarea").send_keys("ยืม")

    driver.find_element(By.XPATH, "//button[text()='ยกเลิก']").click()
    time.sleep(2)
    
    driver.save_screenshot(os.path.join(folder_name, "TC_INBorrowKaruphan_06.png"))
    time.sleep(1)
